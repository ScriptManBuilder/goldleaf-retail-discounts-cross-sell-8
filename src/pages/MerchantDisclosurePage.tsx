      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "GOLDLEAF" or "GLDF*[Retail Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "GOLDLEAF DISCOUNTS" or retailer names for specific purchases
              </LegalListItem>
              <LegalListItem>
